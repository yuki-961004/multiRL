...
testthat::test_that("L-BFGS-B", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "L-BFGS-B", iter = 5)
  )
...
testthat::test_that("GenSA", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "GenSA", iter = 5)
  )
...
testthat::test_that("GA", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "GA", iter = 5)
  )
...
testthat::test_that("DEoptim", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "DEoptim", iter = 5)
  )
...
testthat::test_that("PSO", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "PSO", iter = 5)
  )
...
testthat::test_that("Bayesian", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "Bayesian", iter = 5)
  )
...
testthat::test_that("CMA-ES", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "CMA-ES", iter = 5)
  )
...
testthat::test_that("NLOPT", {
  ...
  multiRL.model <- multiRL::estimate_1_LBI(
    ...
    lower = c(0, 0),
    upper = c(1, 1),
    control = list(algorithm = "NLOPT_GN_MLSL", iter = 5)
  )
