...
#'
#'          This function specifies how prediction error (PE) is incorporated
#'          into value updating, using a learning rate that determines whether
#'          updates are more conservative or more aggressive in response to PE.
#'
