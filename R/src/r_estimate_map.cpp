...
Rcpp::List r_estimate_map(
    ...
    multiRL::modify_outputs::OutputEstimator estimator_out =
        multiRL::modify_outputs::nlopt_estimator("MAP", control.mle.nlopt);

    return wrap_estimate_map_result(tasks, result, estimator_out);
}