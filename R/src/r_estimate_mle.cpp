...
Rcpp::List r_estimate_mle(
    ...
    control.nlopt.lower_bounds = multiRL_r::as_double_vector(lower_bounds);
    control.nlopt.upper_bounds = multiRL_r::as_double_vector(upper_bounds);
