...
inline multiRL::StringMatrix as_string_matrix(
...
inline multiRL::DoubleMatrix as_double_matrix(
...
inline std::vector<std::string> as_string_vector(
...
inline std::vector<int> as_int_vector(const Rcpp::IntegerVector& vector) {
...
inline std::vector<double> as_double_vector(
...
inline multiRL::Params as_params(
...
inline multiRL::PriorGroup as_priors(
...
inline Rcpp::NumericMatrix wrap_double_matrix(
...
inline Rcpp::CharacterMatrix wrap_string_matrix(
...
inline Rcpp::List wrap_metric(const multiRL::CriterionResult& metric) {
    return Rcpp::List::create(
        Rcpp::_["ACC"] = metric.acc,
        Rcpp::_["LogL"] = metric.log_likelihood,
        Rcpp::_["LogPr"] = metric.log_prior,
        Rcpp::_["LogPo"] = metric.log_posterior,
        Rcpp::_["NLL"] = metric.nll,
        Rcpp::_["AIC"] = metric.aic,
        Rcpp::_["BIC"] = metric.bic
    );
}

inline Rcpp::DataFrame wrap_fit(const multiRL::CriterionResult& metric) {
...
inline Rcpp::List wrap_run_result(
    ...
    return Rcpp::List::create(
        Rcpp::_["metric"] = wrap_metric(result.metric),
...
inline multiRL::RunTask make_task(
...
inline std::vector<multiRL::RunTask> make_subject_tasks(
    Rcpp::CharacterMatrix object,
    Rcpp::NumericMatrix reward,
    Rcpp::CharacterVector action,
    Rcpp::IntegerVector block,
    ...
    return multiRL::split_task_by_subject(
        make_task(
            object,
            reward,
            action,
...
inline std::string task_subid(const multiRL::RunTask& task) {
