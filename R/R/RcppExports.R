...
.estimate_abc <- function(object, reward, action, block, trial, idinfo, exinfo, cue, rsp, params, free_names, system, prior_names, prior_types, prior_param1, prior_param2, prior_active, policy, name, mode, samples, tol, method, reduction, n_comp, seed, threads, print_level, lower_bounds, upper_bounds) {
    .Call(`_multiRLcpp_r_estimate_abc`, object, reward, action, block, trial, idinfo, exinfo, cue, rsp, params, free_names, system, prior_names, prior_types, prior_param1, prior_param2, prior_active, policy, name, mode, samples, tol, method, reduction, n_comp, seed, threads, print_level, lower_bounds, upper_bounds)
}
