...
#'    latent rule. For example, in the arrow paradigm of Rmus et al. 
#'    (\href{https://doi.org/10.1371/journal.pcbi.1012119}{2024}), 
...
#'          in the arrow paradigm of Rmus et al. 
#'          (\href{https://doi.org/10.1371/journal.pcbi.1012119}{2024}), 
...
#' \url{https://doi.org/10.1371/journal.pcbi.1012119}
#' 
NULL