...
#'
#'          A numeric vector representing the bias associated with each
#'          option. By default, it follows an Upper Confidence Bound (UCB)
#'          scheme, where options selected less frequently receive larger
#'          bias values.
#'
#'          Alternative biasing strategies are also supported, such as
#'          stickiness to the previously chosen option, the last chosen
#'          position, or the most recently updated template.
#'
#'          The bias only affects the probability of selecting an option,
#'          and does not influence value updating.
#'
