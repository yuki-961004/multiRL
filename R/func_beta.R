...
#'
#'          A numeric vector representing the probability of selecting each
#'          option.
#'
#'          The inverse temperature parameter \code{beta} in the softmax
#'          function primarily controls these probabilities. Larger values
#'          of \code{beta} make choices more sensitive to differences in
#'          Q-values, while smaller values make choices closer to random.
#'
#'          In addition, the \code{lapse} parameter prevents the probability
