...
pybind11::dict py_wrap_estimate_abc_result(
...
pybind11::dict py_wrap_recovery_result(
...
pybind11::dict py_wrap_estimate_mcmc_result(
    ...
    module.def(
        ...
        []() {
            throw std::runtime_error(
                "MCMC is not available. Stan Math support is disabled."
            );
        }
    );
#endif
